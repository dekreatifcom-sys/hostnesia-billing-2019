...
import { useDomains, useTlds } from "@/lib/queries";
import { idr, dateID } from "@/lib/format";
import { Input } from "@/components/ui/input";
import { Button } from "@/components/ui/button";
import { Search, Globe, CheckCircle2, XCircle, Loader2, ShoppingCart, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="space-y-6" data-testid="domains-page">
      <div>
        ...
        <p className="text-sm text-slate-400">Cari, daftar, dan kelola domain Anda.</p>
      </div>
